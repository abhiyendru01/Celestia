...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-6">
      ...
      >
        <div className="absolute top-10 left-10 w-64 h-64 bg-purple-500/20 rounded-full filter blur-3xl" />
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-blue-500/20 rounded-full filter blur-3xl" />
      </motion.div>
      ...
      >
        ...
        <Link to="/your-moon">
          <motion.button 
            className="px-8 py-3 rounded-full bg-transparent border border-space-silver/30 hover:border-space-silver/60 text-space-silver font-medium transition-all"
