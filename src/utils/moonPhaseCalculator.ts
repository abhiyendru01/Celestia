...
export async function fetchUpcomingSpaceEvents(): Promise<{
  ...
  try {
    ...
    const upcomingEvents = [
      {
        title: `${currentMonthName} Meteor Shower`,
      ...
      {
        title: `${currentMonthName} Lunar Eclipse`,
        ...
        image: "https://images.unsplash.com/photo-1548087113-fe1e9a0d1df0",
        type: "Eclipse",
      ...
      {
        title: `${currentMonthName} Saturn Opposition`,
      ...
      {
        title: `${currentMonthName} New Moon`,
        ...
        image: "https://images.unsplash.com/photo-1532978379173-523e16f371f4",
        type: "Lunar Phase",
